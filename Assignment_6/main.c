...
int main(void)
{
	...
	y4=(!a)|(!b);
        if (y1 == 1)
        {
            PyHal_GPIO_Set(22,1); //Turn red LED off
        }
        else
        {
            PyHal_GPIO_Set(22,0); //Turn red LED on
        }
        if (y3 == 1)
        {
            PyHal_GPIO_Set(21,1); //Turn green LED off
        }
        else
        {
            PyHal_GPIO_Set(21,0); //Turn green LED on
        }
        if ((y1 == y2)&(y3==y4))
        {
